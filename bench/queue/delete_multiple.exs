...
Benchee.run(%{
  ...
  "SimpleQueue" => fn -> Runner.run_times(simple_queue, &SimpleQueue.delete_first/1) end,
  "PeekableQueue" => fn -> Runner.run_times(peekable_queue, &PeekableQueue.delete_first/1) end,
